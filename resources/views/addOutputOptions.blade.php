                ...
                <form method="POST" action="/home/channel/{{$urlParts[5]}}">
                    ...
                    <ul>
                        ...
                        <uL>
                            ...
                            <div>
                                <li> Frame rate :
                                    ...
                                    <select name="fr" style=" font-size: 13px;padding: 5px; background: #fff;border: 1px solid #ccc; border-radius: 6px;overflow: hidden;position: relative;width:30%; margin-left:7.7%">
                                        ...
                                        <option value="25" name="25" selected>25 </option>
                            ...
                            <div>
                                <li>
                                    Keyframe : <input required type="text" name="keyframe" style=" font-size: 13px;padding: 5px; background: #fff;border: 1px solid #ccc; border-radius: 6px;overflow: hidden;position: relative;width:30%; margin-left:8.9%"> sec
                                </li>
                            </div>
                            <br>
                            <div>
                                <li>
                                    Number of B frames : <input required type="number" name="bFrames" style=" font-size: 13px;padding: 5px; background: #fff;border: 1px solid #ccc; border-radius: 6px;overflow: hidden;position: relative;width:30%; margin-left:2.9%">
                                </li>
                            </div>
                            <br>
                            <div>
                            ...
                            <div id="mode" style="display: none">
                                Mode <select name="mode" style=" font-size: 13px;padding: 5px; background: #fff;border: 1px solid #ccc; border-radius: 6px;overflow: hidden;position: relative;width:30%; margin-left:9.4%">
                                    <option id="0" value="00">Select ...</option>
                            ...
                            <div id="parity" style="display: none">
                                Parity <select name="mode" style=" font-size: 13px;padding: 5px; background: #fff;border: 1px solid #ccc; border-radius: 6px;overflow: hidden;position: relative;width:30%; margin-left:9.4%">
                                    <option id="0" value="00">Select ...</option>
                            ...
                            <div id="deint" style="display: none">
                                Deint <select name="mode" style=" font-size: 13px;padding: 5px; background: #fff;border: 1px solid #ccc; border-radius: 6px;overflow: hidden;position: relative;width:30%; margin-left:9.4%">
                                    <option id="0" value="00">Select ...</option>
                            ...
                            <div>
                                <li> Sample rate :
                                    ...
                                    <select name="sr" style=" font-size: 13px;padding: 5px; background: #fff;border: 1px solid #ccc; border-radius: 6px;overflow: hidden;position: relative;width:30%; margin-left:7%">
                                        ...
                                        <option value="44100" name="44100" selected>44100</option>
